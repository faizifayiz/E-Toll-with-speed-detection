...
<div class="sidebar" data-color="yh" >
    	...
    	<div class="sidebar-wrapper">
            ...
            <br/> <br/>
               ...
               <a href="../dashboard/dashboard.php"><img src="../common/core-img/images.png"  width="195" height="110"></a> 
            ...
            <ul class="nav">
                <li >
                    <a href="../dashboard/dashboard.php">
                        <div class="font-icon-detail"></i><i class="pe-7s-home"></i>
    ...
    <div class="main-panel" style=" background-image: url(../dashboard/bgtoll.jpg); background-size:cover;">
